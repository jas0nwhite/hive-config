...
package object values {
  ...
  val ABF_DACCOUNT = 8 //                       number of DAC channels supported.
  val ABF_EPOCHCOUNT = 50 //                    number of waveform epochs supported. //ST-1 : maximum epochs updated from 10 to 50
  ...
  val ABF_USERLISTCOUNT = ABF_DACCOUNT //       number of independent user lists (V1.6)
  ...
  val PCLAMP11_MAXSWEEPLEN_PERCHAN = 5161290 // Maximum per channel sweep length supported by pCLAMP11 apps. //ST-1
